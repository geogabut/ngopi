...
echo -e "${Info} Wireguard VPS AutoScript by gabut"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/geogabut/ngopi/main/wireguard/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/geogabut/ngopi/main/wireguard/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/geogabut/ngopi/main/wireguard/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/geogabut/ngopi/main/wireguard/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
