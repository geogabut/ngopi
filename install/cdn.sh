...
#download
wget -O /usr/local/bin/PDirect.py https://raw.githubusercontent.com/geogabut/ngopi/main/install/PDirect.py
...
[Unit]
Description=Python Edu Proxy Script By gabut
Documentation=https://t.me/sampiiiiu
After=network.target nss-lookup.target
[Service]
Type=simple
...
wget -O /usr/local/bin/ovpn.py https://raw.githubusercontent.com/geogabut/ngopi/main/install/ovpn.py
