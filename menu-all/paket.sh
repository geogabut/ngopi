...
wget -O /usr/bin/pointing https://raw.githubusercontent.com/geogabut/ngopi/main/pointing.sh && chmod +x /usr/bin/pointing && cd /usr/bin && apt install -y dos2unix && dos2unix pointing
wget -O /usr/bin/editsm https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/editsm && chmod +x /usr/bin/editsm
wget -O /usr/bin/bench-network https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/bench-network && chmod +x /usr/bin/bench-network && cd /usr/bin && apt install -y dos2unix && dos2unix bench-network
wget -O /usr/bin/log-limit https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/log-limit && chmod +x /usr/bin/log-limit
wget -O /usr/bin/updatescript https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/updatescript && chmod +x /usr/bin/updatescript
wget -O /usr/bin/user-generate https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/user-generate && chmod +x /usr/bin/user-generate
wget -O /usr/bin/user-delete-expired https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/user-delete-expired && chmod +x /usr/bin/user-delete-expired
wget -O /usr/bin/user-list https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/user-list && chmod +x /usr/bin/user-list
wget -O /usr/bin/user-lock https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/user-lock && chmod +x /usr/bin/user-lock
wget -O /usr/bin/user-password https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/user-password && chmod +x /usr/bin/user-password
wget -O /usr/bin/user-unlock https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/user-unlock && chmod +x /usr/bin/user-unlock
wget -O /usr/bin/antitorrent https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/antitorrent && chmod +x /usr/bin/antitorrent
...
wget -O /usr/bin/geo https://raw.githubusercontent.com/geogabut/ngopi/main/geo.sh && chmod +x /usr/bin/geo && cd /usr/bin && apt install -y dos2unix && dos2unix geo
...
wget -O /usr/bin/format https://raw.githubusercontent.com/geogabut/ngopi/main/menu-all/format && chmod +x /usr/bin/format && cd /usr/bin && apt install -y dos2unix && dos2unix format
wget -O /usr/bin/clear-log https://raw.githubusercontent.com/geogabut/ngopi/main/clear-log.sh && chmod +x /usr/bin/clear-log && cd /usr/bin && apt install -y dos2unix && dos2unix clear-log
wget -O /usr/bin/autoreboot https://raw.githubusercontent.com/geogabut/ngopi/main/autoreboot.sh && chmod +x /usr/bin/autoreboot && cd /usr/bin && apt install -y dos2unix && dos2unix autoreboot
